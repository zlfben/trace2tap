...
COPY public.backend_device (id, public, dev_type, name, icon, location_id, is_subscribed) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.backend_parvalmapping_id_seq', 6, true);
...
COPY public.backend_stcapability (id, name) FROM stdin;
1	switch
2	switchLevel
3	colorControl
4	audioVolume
...
SELECT pg_catalog.setval('public.backend_stcapability_capabilities_id_seq', 7, true);
...
SELECT pg_catalog.setval('public.backend_stcapability_id_seq', 7, true);
...
SELECT pg_catalog.setval('public.backend_userprofile_id_seq', 3, true);
