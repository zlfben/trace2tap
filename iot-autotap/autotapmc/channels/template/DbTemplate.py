...
template_dict = {
    ...
    'speakers': {'fm_tuner_frequency': 'numeric', 'power_onoff_setting': 'bool', 'volume_level': 'numeric', 'genre_genre': 'set, [Pop, Jazz, RB, HipHop, Rap, Country, News]'},
    ...
    'weather_sensor': {'is_it_raining_condition': 'bool, external', 'weather_sensor_weather': 'set, external, [Sunny, Cloudy, PartlyCloudy, Raining, Thunderstorms, Snowing, Hailing, Clear]', 'current_temperature_temperature': 'numeric, external'},
